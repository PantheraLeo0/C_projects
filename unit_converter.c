    ...
    if(option == 1){
        ...
        if(option == 3){
            ...
            switch(option){
                ...
                goto home;
                break;
                case 2: kilometer_to_millimeter();
                goto home;
                break;
                case 3: kilometer_to_meter();
                goto home;
                break;
        ...
        if(option == 4){
            ...
            switch(option){
                ...
                goto home;
                break;
                case 2: mile_to_millimeter();
                goto home;
                break;
                case 3: mile_to_meter();
                goto home;
                break;
                case 4: mile_to_kilometer();
                goto home;
                break;
                case 5: mile_to_yard();
                goto home;
        ...
        if(option == 5){
            ...
            switch(option){
                ...
                goto home;
                break;
                case 2: yard_to_millimeter();
                goto home;
                break;
                case 3: yard_to_meter();
                goto home;
                break;
                case 4: yard_to_mile();
                goto home;
                break;
                case 5: yard_to_kilometer();
                goto home;
                break;
                case 6: yard_to_foot();
                goto home;
        ...
        if(option == 6){
            ...
            switch(option){
                ...
                goto home;
                break;
                case 2: Foot_to_millimeter();
                goto home;
                break;
                case 3: Foot_to_meter();
                goto home;
                break;
                case 4: Foot_to_mile();
                goto home;
